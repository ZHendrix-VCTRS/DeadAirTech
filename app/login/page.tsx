...
export default function LoginPage() {
  ...
  const inputClass =
    "terminal-input mt-1 w-full rounded px-3 py-2 font-body text-[15px] text-dead-text outline-none";

  return (
    <div className="mx-auto max-w-md space-y-8">
      <header className="space-y-2 text-center">
        <h1 className="font-display text-base text-dead-neon sm:text-lg">LOG IN</h1>
        <p className="font-body text-[15px] text-[#808080]">
          Vote more than five times per project. Judge strangers. Feel alive.
        </p>
      </header>

      <div className="flex justify-center gap-2 font-display text-[10px]">
        <button
          type="button"
      ...
      <form onSubmit={mode === "magic" ? magicLink : passwordAuth} className="space-y-4">
        <div>
          <label htmlFor="email" className="block font-display text-[10px] text-[#a0a0a0]">
            EMAIL
          </label>
          <input
            id="email"
        ...
        {mode === "password" && (
          <div>
            <label htmlFor="password" className="block font-display text-[10px] text-[#a0a0a0]">
              PASSWORD
            </label>
            <input
              id="password"
        ...
        {message && <p className="font-body text-[15px] text-dead-neon">{message}</p>}
      ...
      <p className="text-center font-body text-[13px] text-[#555]">
